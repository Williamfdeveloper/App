        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TB_USUARIO_AspNetUsers_IdentityUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TB_PESSOA_ENDERECO", x => new { x.ID_ENDERECO, x.CD_USUARIO });
                    table.ForeignKey(
                        name: "FK_TB_PESSOA_ENDERECO_TB_USUARIO_UsuarioId",
                        column: x => x.UsuarioId,
                        principalSchema: "dbo",
                        principalTable: "TB_USUARIO",
                        principalColumn: "CD_USUARIO",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("2a6b42a3-7798-46dc-825a-a343d873e45b"), "mail.v2wstore.com.br", 465, "V2WMedia", 1, "williamf.developer@outlook.com", "BR@sil500" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TB_PESSOA_ENDERECO_UsuarioId",
                schema: "dbo",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TB_USUARIO_IdentityUserId",
                schema: "dbo",
                table: "TB_USUARIO",
