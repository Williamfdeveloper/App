...
namespace App.Repository.Migrations
{
    ...
    [Migration("20220901015246_updatedatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Domain.Entities.EmailSistema", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("b44af0bc-815c-4d5d-8281-b0a19d510501"),
            ...
            modelBuilder.Entity("App.Domain.Entities.LogEvento", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("CD_LOG_ERRO")
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("codigoErro")
                        .HasColumnName("CD_ERRO")
                        .HasColumnType("int");

                    b.Property<DateTime?>("createdtime")
                        .IsRequired()
                        .HasColumnName("DH_LOG_ERRO")
                        .HasColumnType("datetime2");

                    b.Property<string>("exception")
                        .IsRequired()
                        .HasColumnName("DC_EXCEPTION")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("message")
                        .IsRequired()
                        .HasColumnName("DC_MESSAGE")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("id");

                    b.ToTable("TB_LOG_ERRO","dbo");
                });
            ...
            modelBuilder.Entity("App.Domain.Entities.ParametrosSistema", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            parametrosid = new Guid("75c3c26a-a03f-4519-b245-ad891bf4821f"),
                        ...
                        new
                        {
                            parametrosid = new Guid("85334f72-d670-4104-925e-dd01a16431d1"),
                        ...
                        new
                        {
                            parametrosid = new Guid("3053cf06-64fa-46c2-9511-8651a1dc2b5b"),
                        ...
                        new
                        {
                            parametrosid = new Guid("9ae46767-a740-4342-a981-aafe14b254a8"),
                        ...
                        new
                        {
                            parametrosid = new Guid("cc5a4b80-1b13-4f3a-8b02-3d41ed442002"),
                        ...
                        new
                        {
                            parametrosid = new Guid("8388deb0-036c-4024-ab4b-bd5edb508c84"),
                        ...
                        new
                        {
                            parametrosid = new Guid("921e1ed3-f931-4ca7-9013-9a96ddb83e82"),
            ...
            modelBuilder.Entity("App.Domain.Entities.PedidoHistorico", b =>
                {
                    ...
                    b.Property<int>("CodigoPedidoHistorico")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("CD_PEDIDO_HISTORICO")
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("CodigoPedido", "CodigoPedidoHistorico");
