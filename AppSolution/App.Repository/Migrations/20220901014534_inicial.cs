        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DH_ATUALIZACAO_PEDIDO = table.Column<DateTime>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TB_PEDIDO_ITEM_TB_PEDIDO_CD_PEDIDO",
                        column: x => x.CD_PEDIDO,
                        principalSchema: "dbo",
                        principalTable: "TB_PEDIDO",
                        principalColumn: "CD_PEDIDO",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TB_PEDIDO_ITEM_TB_PRODUTO_CD_PRODUTO",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TB_PEDIDO_PAGAMENTO_TB_PEDIDO_CD_PEDIDO",
                        column: x => x.CD_PEDIDO,
                        principalSchema: "dbo",
                        principalTable: "TB_PEDIDO",
                        principalColumn: "CD_PEDIDO",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TB_PEDIDO_PAGAMENTO_HISTORICO_TB_PEDIDO_PAGAMENTO_CD_PEDIDO_PAGAMENTO",
                        column: x => x.CD_PEDIDO_PAGAMENTO,
                        principalSchema: "dbo",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("06d11fb4-55bc-47e3-8fa6-7710288f3244"), "mail.v2wstore.com.br", 465, "V2WMedia", 1, "williamf.developer@outlook.com", "BR@sil500" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TB_PEDIDO_ITEM_CD_PEDIDO",
                schema: "dbo",
                table: "TB_PEDIDO_ITEM",
                column: "CD_PEDIDO");

            migrationBuilder.CreateIndex(
                name: "IX_TB_PEDIDO_ITEM_CD_PRODUTO",
                schema: "dbo",
                table: "TB_PEDIDO_ITEM",
                column: "CD_PRODUTO");

            migrationBuilder.CreateIndex(
                name: "IX_TB_PEDIDO_PAGAMENTO_CD_PEDIDO",
                schema: "dbo",
                table: "TB_PEDIDO_PAGAMENTO",
                column: "CD_PEDIDO");

            migrationBuilder.CreateIndex(
                name: "IX_TB_PEDIDO_PAGAMENTO_HISTORICO_CD_PEDIDO_PAGAMENTO",
                schema: "dbo",
                table: "TB_PEDIDO_PAGAMENTO_HISTORICO",
                column: "CD_PEDIDO_PAGAMENTO");
        }
